...
import com.social.back.business.service.subscription.StandardSubscriptionManager;
...
public class AppConfiguration {
    ...
    @Bean
    StandardSubscriptionManager standardSubscriptionManager(SubscriptionRepository subscriptionRepository, AuthorRepository authorRepository) {
        return new StandardSubscriptionManager(subscriptionRepository, authorRepository);
    }
