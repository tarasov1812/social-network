...
const btn1 = document.getElementsByClassName('login')[0];
const btn2 = document.getElementsByClassName('login')[1];

// Get the <span> (x) element that closes the modal
const span = document.getElementsByClassName('close-button')[1];
